...
const CustomerDashboard = () => {
  ...
  // Helper to format location: state, country
  ...
  // Filter artisans by combined search term (services + location + address)
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      {/* Search Services, Location, or Address */}
      ...
      {orderLoading ? (
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '800px', marginBottom: '30px' }}>
            <thead>
              <tr>
                <th style={thStyle}>Name</th>
                <th style={thStyle}>Phone</th>
